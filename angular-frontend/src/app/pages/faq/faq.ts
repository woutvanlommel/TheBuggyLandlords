...
@Component({
  ...
  template: `
    <div
      class="flex flex-col h-screen w-full bg-[#0047AB] p-12 text-white font-sans overflow-hidden"
    >
      <h1 class="text-6xl font-light mb-16 text-center w-full">FAQ</h1>

      <div class="flex flex-1 gap-12 overflow-hidden items-start">
        <div
          class="flex flex-col w-1/3 pr-8 border-r border-white/30 overflow-y-auto h-full custom-scrollbar"
        >
              ...
              *ngFor="let topic of faqData"
              ...
              [ngClass]="
                activeTopic === topic.id
                  ? 'bg-white/90 text-blue-900 font-bold'
        ...
        <div class="flex flex-col flex-1 pl-8 overflow-y-auto h-full custom-scrollbar min-w-0">
          <ng-container *ngFor="let topic of faqData">
            <div *ngIf="activeTopic === topic.id" class="topic-section">
              <div
                *ngFor="let item of topic.questions"
              ...
              >
                ...
                >
                  ...
                  <span
                    class="text-4xl font-thin flex-none transition-transform duration-300"
                    [class.rotate-45]="activeQuestion === item.id"
                    >+</span
                  >
                </button>
                ...
                >
                  <div
                    class="mt-6 text-white/70 leading-relaxed max-w-2xl pb-4"
