          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-4 space-y-8">
              ...
              >
                ...
                <div class="space-y-5">
                  ...
                  <div class="pt-4 mt-4 border-t border-dashed border-base-twee-100">
                    <label
                      class="block text-[10px] font-black text-base-twee-600 uppercase mb-2 ml-1"
              ...
              >
                ...
                @if (activeTenant) {
                  <div
                    class="group relative bg-base-een-50 rounded-3xl p-6 border border-base-een-200"
                  >
                    ...
                    <div class="space-y-2 mb-6">
                      ...
                      @if (activeTenant.end_date) {
                        <div
                          class="flex justify-between text-[10px] text-base-twee-500 font-medium"
                        >
                          <span>Einddatum</span>
                          <span class="text-base-twee-700">{{
              ...
              >
                ...
                <div class="space-y-10">
                      ...
                      @for (cost of oneTimeCosts; track cost.id) {
                        ...
                        >
                          <div class="flex flex-col">
                            <span class="text-xs text-base-twee-700 font-black">{{
                              cost.name
                            }}</span>
                  ...
                  <div class="space-y-4">
                    <h3
                      class="text-[9px] font-black text-primary-500 uppercase tracking-widest ml-2"
                    >
                      Maandelijkse Kosten
                    </h3>
                    <div class="space-y-3">
                    ...
                    <div class="md:col-span-2">
                      ...
                      >
                        @if (mainImage) {
                          ...
                          >
                            <span
                              class="text-white font-black uppercase text-[10px] tracking-widest"
                              >Wijzigen</span
                            >
                          </div>
                        } @else {
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div class="md:col-span-1">
                      ...
                      <div class="flex flex-col gap-2 items-start justify-start">
                        <p class="text-xs text-base-twee-400 font-medium leading-relaxed">
                          Voeg detailfoto's toe: de badkamer, het uitzicht, opbergruimte of de
                          keuken.
                        </p>
                        <p class="text-xs text-base-twee-400 font-medium leading-relaxed">
  ...
  async saveRoom() {
    ...
    try {
      const cleanedDescription =
        typeof this.room.description === 'string'
          ? this.room.description.replace(/&nbsp;/g, ' ')
